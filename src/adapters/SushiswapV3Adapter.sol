...
import "../interfaces/ISushiswapv3Callback.sol";

enum ComputeType {
    Swap
}

contract SushiswapV3Adapter is OceanAdapter, ISushiswapv3Callback {
    /////////////////////////////////////////////////////////////////////
    //                             Errors                              //
    /////////////////////////////////////////////////////////////////////
    ...
    constructor(address ocean_, address primitive_) OceanAdapter(ocean_, primitive_) {
        address xTokenAddress = ISushiswapV3Pool(primitive_).token0();
        ...
        address yTokenAddress = ISushiswapV3Pool(primitive_).token1();
    ...
    function primitiveOutputAmount(uint256 inputToken, uint256 outputToken, uint256 inputAmount, bytes32 minimumOutputAmount) internal override returns (uint256 outputAmount) {
        ...
        // Try swapping.
        (int256 amount0, int256 amount1) = ISushiswapV3Pool(primitive).swap({
    ...
    /// @notice The Sushiswap V3 pool callback where the token transfer is expected to happen.
    ...
    function sushiswapV3SwapCallback(int256 _amount0Delta, int256 _amount1Delta, bytes calldata _data) external override {
